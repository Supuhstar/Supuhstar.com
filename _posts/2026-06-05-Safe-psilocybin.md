...
> ### ⚠️ Important!
>
> Psilocybin _isn't_ used to get high. While a high is part of it, the overall experience is much more **spiritual**, and should be treated as such.
>
> If you use psilocybin, you _must_ understand that you _will_ have a much more introspective experience than, for example, a THC high.
>
...
In many of these places where psilocybin is legal, it's not yet legal to purchase nor sell shrooms, but it is legal to grow them yourself at home.

If you can legally get them from a trusted source without growing them yourself, that'll be _much_ easier, and We recommend it. In that case, you can skip this Growing section.

If you decide to grow the mushrooms yourself, thankfully it's just like growing any other food-grade mushrooms, except since these are psychadelic, this comes with the added caution of making sure no one and nothing eats them thinking they're food. Feel free to follow any other guide for growing food-grade mushrooms.



### Get the materials

You'll need to get a few things to make sure they can grow healthy:
...
If you bought a premade Grow Bag, you can skip this step, because it should have already been pasteurized.

Otherwise, once you have the **growth medium** and **bag/box**, you need to pasteurize or sterilize the growth medium, and sterilize the bag/box. You want to pasteurize growth medium that has beneficial microbes in it (like grains, agar, etc.), but sterilize growth medium that should be fully dead (wood, straw, vermiculite, etc.).

Pasteurization means keeping it at a high temperature but still below boiling (like 70ºC/150ºF) for an extended period (like 1~2 hours) in a wet environment (hot water bath or steamed).

I encourage you to watch various videos detailing the best practices for pasteurization, and follow whichever works best for your setup, since there are many approaches.

You can sterilize the growth medium in a pressure cooker (120ºC/250ºF) for ½~2 hours.

For the bag/box, spraying/wiping it down with rubbing alcohol should be enough. Avoid using heat that might soften/melt the plastic.
...
- Sweating/chills, feeling hot/cold
- Mild tremors
- Mild arrhythmia
- Yawning
- Weakness
...
- Plurality effects (frontstuck, rapid switches, visitation, discovery, age sliding, etc.)
- Past-life memory recovery
- A sense of "oneness"
...
- Don't crossfade, especially:
    - Alcohol, cannabis, other psychedelics
    - Lithium (high chance of seizures)
    - MAOIs, SSRIs/SNRIs, tramadol, ondansetron, linezolid
    - Heavy caffeine
- Let a trip guide itself
- Flow through what comes, no avoiding mental difficulties 
- No driving for 24hrs
- No major decisions for 48hrs
